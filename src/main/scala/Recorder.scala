...
object Recorder extends App {
	...
	GatlingHttpProxyUI.main(Array(OUTPUT_FOLDER_OPTION, recorderOutputFolder, PACKAGE_OPTION, "com.roddet.gatling", REQUEST_BODIES_FOLDER_OPTION, requestBodiesFolder))
}